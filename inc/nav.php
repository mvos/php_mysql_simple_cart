			<div class="menu-wrap">
				...
				<ul class="sf-menu">
					<li>
						<a href="http://ec2-54-233-84-173.sa-east-1.compute.amazonaws.com/index.php">Home</a>
					</li>
					<li>
						<a href="#">Shop</a>
					...
					<li>
						...
						<div class="mobnav-subarrow"><i class="fa fa-plus"></i></div>
						<ul>
							<li><a href="http://ec2-54-233-84-173.sa-east-1.compute.amazonaws.com/my-account.php">My Orders</a></li>
							<li><a href="http://ec2-54-233-84-173.sa-east-1.compute.amazonaws.com/edit-address.php">Update Address</a></li>
							<li><a href="http://ec2-54-233-84-173.sa-east-1.compute.amazonaws.com/logout.php">Logout</a></li>
						</ul>
					</li>
					<li>
						<a href="#">Contact</a>
